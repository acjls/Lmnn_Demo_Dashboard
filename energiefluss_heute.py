...
def get_EE_card():
    EE_card = dmc.Card(
        [
            html.Div("Erneuerbare Energieversorgung (heute)", style={"font-size": "18px", "color": "#ffffff", "text-align": "center", "margin-bottom": "10px"}),
            html.Div("96 %", style={"font-size": "32px", "color": "#ffffff", "text-align": "center"})
        ],
